...
- 느린 신호: `[0.0, 0.4, 0.8, 1.0]`
- 빠른 신호: `[0.0, 1.0, 0.0, -1.0]`

첫 번째는 천천히 변하고, 두 번째는 짧은 구간에서 빠르게 흔들린다. 이 차이가 바로 저주파와 고주파 감각이다. positional encoding에서 여러 주파수를 함께 쓰는 이유는 문장 안의 가까운 변화와 먼 변화 둘 다 잡기 위해서다.
