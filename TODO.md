...
- [x] 모든 핵심 장에 한국어 초안이 있다.
- [x] 모든 핵심 장에 영어 대응 페이지가 있다.
- [x] 모든 핵심 장에 "이 장에서 꼭 가져갈 한 문장"이 있다.
- [x] 모든 핵심 장에 "다음 장 연결"이 있다.
- [x] 모든 핵심 장에 최소 1개의 체크리스트, 질문, 또는 연습 문제가 있다.

### B. 장별 완료 체크

- [x] 프롤로그와 학습 가이드 1차 완성
- [x] 수학 기초 1차 완성
- [x] Python과 PyTorch 1차 완성
- [x] 딥러닝 기본기 1차 완성
- [x] NLP와 Transformer 이전 배경 1차 완성
- [x] Transformer 핵심 1차 완성
- [x] GPT-1 -> GPT-3 이해 1차 완성
- [x] LLM 실전 기본기 1차 완성
- [x] 강화학습과 RLHF 입문 1차 완성
- [x] 최신 AI 엔지니어링 실무 패턴 1차 완성
- [x] 프로젝트 기반 학습 1차 완성

### C. 1차 패스 종료 조건

- [x] 사이트 빌드가 통과한다.
- [x] GitHub Pages 배포가 통과한다.
- [x] 로드맵과 TODO가 현재 상태와 맞는다.
- [x] 위 항목이 모두 체크되면 "1차 패스 완료"로 간주하고 사용자에게 노티스한다.
...
- [x] 토큰 길이, 컨텍스트 윈도우, 샘플링 파라미터를 설명한다.
- [x] 프롬프트 설계의 기본 패턴을 정리한다.
- [x] 평가의 기본 단위: accuracy, BLEU/ROUGE류, human eval, task eval을 비교한다.
- [x] hallucination, bias, safety, 비용 문제를 다룬다.
...
- 이후 작업은 `1차 패스 완료용 TODO`를 기준으로 진행하고, 전부 체크되면 완료 노티스를 보낸다.
