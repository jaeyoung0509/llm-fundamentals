...
- [ ] 모든 핵심 장에 한국어 초안이 있다.
- [ ] 모든 핵심 장에 영어 대응 페이지가 있다.
- [ ] 모든 핵심 장에 "이 장에서 꼭 가져갈 한 문장"이 있다.
- [ ] 모든 핵심 장에 "다음 장 연결"이 있다.
- [ ] 모든 핵심 장에 최소 1개의 체크리스트, 질문, 또는 연습 문제가 있다.

### B. 장별 완료 체크

- [ ] 프롤로그와 학습 가이드 1차 완성
- [ ] 수학 기초 1차 완성
- [ ] Python과 PyTorch 1차 완성
- [ ] 딥러닝 기본기 1차 완성
- [ ] NLP와 Transformer 이전 배경 1차 완성
- [ ] Transformer 핵심 1차 완성
- [ ] GPT-1 -> GPT-3 이해 1차 완성
- [ ] LLM 실전 기본기 1차 완성
- [ ] 강화학습과 RLHF 입문 1차 완성
- [ ] 최신 AI 엔지니어링 실무 패턴 1차 완성
- [ ] 프로젝트 기반 학습 1차 완성
